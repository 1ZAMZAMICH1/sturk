...
export const HotelModal = ({ hotel, onClose, onOpenOther }) => {
    ...
    const lang = i18n.language ? i18n.language.split('-')[0] : 'ru';
    const localizedName = hotel[`name_${lang}`] || hotel.name_ru || hotel.name_en || hotel.name;
    const localizedDesc = hotel[`description_${lang}`] || hotel.description_ru || hotel.description_en || hotel.description;
    const localizedLoc = hotel[`location_${lang}`] || hotel.location_ru || hotel.location_en || hotel.location;
